...
import {
  ...
  CheckCircle2, Package, Users, History, Crown, Wallet, Settings,
  ArrowRight, Link as LinkIcon, Gift, Sparkles
} from 'lucide-react'
...
function ProfileContent() {
  ...
  if (!userData) {
    return (
      <div className="flex items-center justify-center min-h-screen p-4 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 pb-24 lg:pb-0">
      <Header />

      {/* Hero Header - Gradient Background */}
      <div className="bg-gradient-to-br from-slate-800 via-slate-700 to-slate-900 p-6 lg:p-8 shadow-2xl">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col lg:flex-row items-center gap-6">
            {/* Avatar */}
            <Avatar className="w-24 h-24 lg:w-32 lg:h-32 border-4 border-white/30 shadow-2xl ring-4 ring-white/10">
              {userData.photoUrl && <AvatarImage src={userData.photoUrl} alt={userData.firstName || userData.username || 'User'} />}
              <AvatarFallback className="bg-gradient-to-br from-blue-500 to-purple-500 text-white text-3xl lg:text-4xl font-bold">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <p className="text-white/70 text-lg mb-3">@{userData.username || 'kullanici'}</p>
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-3">
                ...
                {userData.leaderboardRank && userData.leaderboardRank <= 10 && (
                  <Badge className="bg-gradient-to-r from-yellow-500 to-orange-500 text-white border-0 px-4 py-1.5 text-sm">
                    <Crown className="w-4 h-4 mr-1" />
                    #{userData.leaderboardRank} Sırada
                  </Badge>
                )}
                <Badge variant="outline" className="border-white/30 text-white/70 px-4 py-1.5 text-sm">
      ...
      <div className="max-w-6xl mx-auto px-4 py-6 lg:py-8">
        ...
        {!userData.telegramId ? (
          <Card className="bg-gradient-to-br from-blue-600/20 to-cyan-600/20 border-blue-500/30 p-5 mb-6">
          ...
          <Card className="bg-gradient-to-br from-green-600/20 to-emerald-600/20 border-green-500/30 p-4 mb-6">
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-white font-semibold text-lg">Cüzdan & Sponsor Bilgileri</h3>
        ...
        {/* Rank Progress Card */}
        <Card className="bg-gradient-to-br from-slate-800 to-slate-900 border-slate-700 p-6 mb-6 shadow-xl">
          <div className="flex items-center justify-between mb-5">
            <div className="flex items-center gap-4">
              <div className="w-20 h-20 rounded-full bg-gradient-to-br from-yellow-500/20 to-orange-500/20 border-2 border-yellow-500/50 flex items-center justify-center shadow-lg">
        ...
        {/* Referral Stats */}
        <Card className="bg-gradient-to-br from-orange-600/20 to-red-600/20 border-orange-500/30 p-6 mb-6">
          <h3 className="text-white font-semibold text-xl mb-4 flex items-center gap-2">
