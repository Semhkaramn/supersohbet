...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        id="desktop-sidebar"
        className="hidden lg:flex fixed left-0 top-16 lg:top-20 h-[calc(100vh-4rem)] lg:h-[calc(100vh-5rem)] bg-slate-900/95 backdrop-blur-xl border-r border-white/10 flex-col z-40 w-64"
      >
        {/* Logo */}
        <div className="p-6 border-b border-white/10">
          <div className="flex items-center gap-3">
            ...
            <div className="overflow-hidden">
              <h2 className="text-xl font-bold text-white whitespace-nowrap">Menü</h2>
            </div>
          </div>
        </div>
